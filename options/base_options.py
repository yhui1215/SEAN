...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--name', type=str, default='label2coco', help='name of the experiment. It decides where to store samples and models') # 'label2coco'
        ...
        parser.add_argument('--dataset_mode', type=str, default='coco')  #'coco'
